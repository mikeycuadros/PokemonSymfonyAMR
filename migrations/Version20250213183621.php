 ...
 */
final class Version20250213183621 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pokemon ADD evolution_id INT DEFAULT NULL, ADD state TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pokemon DROP evolution_id, DROP state');
    }
}
