 ...
 */
final class Version20250213170128 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pokemon (id INT AUTO_INCREMENT NOT NULL, evolution_id INT DEFAULT NULL, number INT NOT NULL, name VARCHAR(255) NOT NULL, type JSON NOT NULL COMMENT \'(DC2Type:json)\', image VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_62DC90F3CDFF215A (evolution_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
